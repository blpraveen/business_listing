...
<div style="background-image: url('{{asset('bgg.png')}}') ?>');" class="w3-container" id="parentdiv" >

	
<div id="floatdiv" class="w3-card-8  w3-white">
<div class="w3-margin"><b class="w3-xlarge w3-text-teal w3-margin w3-serif">LOGIN</b></div> <br>
